      ...
      if (sender instanceof Player) {
         if (args.length < 3) {
            ...
            if (targetPlayer == null) {
               ...
               String stat = args[1];
               String value = args[2];
               PersistentDataType<?, ?> dataType = (PersistentDataType)PlayerStats.Stats.get(stat);
               if (dataType == null) {
                  ...
                  if (dataValue != null) {
                     ...
                     sender.sendMessage("Set " + stat + " to " + String.valueOf(dataValue) + " for player " + targetPlayer.getName());
                     return true;
                  } else {
