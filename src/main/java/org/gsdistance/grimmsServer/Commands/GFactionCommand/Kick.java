        ...
        if (args.length < 2) {
            ...
            if (faction == null) {
                ...
                if (targetPlayer == null) {
                    ...
                    return false;
                } else if (!faction.isMember(targetPlayer.getUniqueId())) {
                    player.sendMessage("§cThis player is not a member of your faction.");
                    return false;
                } else if (faction.getMemberRank(player.getUniqueId()).weight <= faction.getMemberRank(targetPlayer.getUniqueId()).weight) {
