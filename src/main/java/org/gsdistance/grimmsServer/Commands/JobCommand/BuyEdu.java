...
public class BuyEdu {
   ...
   public static boolean subCommand(Player player) {
      ...
      int intelligence = (Integer)playerStats.getStat("intelligence", Integer.class);
      double cost = Math.pow((double)intelligence, (double)2.0F) * (double)25.0F;
      double money = (Double)playerStats.getStat("money", Double.class);
      if (money < cost) {
