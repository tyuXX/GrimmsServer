...
public class CustomEnchantmentHandler {
     ...
     */
    public boolean addEnchantment(CustomEnchantments enchantment, int level) {
     ...
     */
    public boolean removeEnchantment(CustomEnchantments enchantment) {
        if (!hasEnchantment(enchantment)) {
            return false;
        }
     ...
     */
    public boolean hasEnchantment(CustomEnchantments enchantment) {
     ...
     */
    public int getEnchantmentLevel(CustomEnchantments enchantment) {
        String key = ENCHANTMENT_PREFIX + enchantment.name();
     ...
     */
    public Map<CustomEnchantments, Integer> getAllEnchantments() {
        Map<CustomEnchantments, Integer> enchantments = new HashMap<>();
        
        for (CustomEnchantments enchantment : CustomEnchantments.values()) {
     ...
     */
    public boolean setEnchantmentLevel(CustomEnchantments enchantment, int level) {
