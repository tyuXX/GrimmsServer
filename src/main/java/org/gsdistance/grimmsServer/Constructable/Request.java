...
public class Request {
   ...
   public static void newRequest(Function<Object, ?> onAccept, Player forPlayer, String forPurpose, Object requestData) {
      ...
      ArrayList<Integer> requestDataList = (ArrayList)((Data)PerSessionDataStorage.dataStore.get("requestData-" + forPlayer.getName())).key();
   ...
   public boolean acceptRequest(Player player) {
      if (this.canAccept(player)) {
         ...
         ArrayList<Integer> requestDataList = (ArrayList)((Data)PerSessionDataStorage.dataStore.get("requestData-" + player.getName())).key();
