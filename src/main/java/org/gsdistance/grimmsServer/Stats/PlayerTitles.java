...
public class PlayerTitles {
   ...
   public void addTitle(String title) {
      ...
      if (!this.hasTitle(title)) {
         ...
         Shared.Broadcast("Title " + title + " was bestowed upon " + this.player.getDisplayName() + ".", (String)null);
   ...
   public void removeTitle(String title) {
      ...
      if (this.hasTitle(title)) {
         ...
         metadata.titles = newTitles;
         Shared.Broadcast("Title " + title + " was revoked from " + this.player.getDisplayName() + ".", (String)null);
         PlayerTitleChecker.checkTitles(this.player);
         metadata.saveToPDS();
      }
